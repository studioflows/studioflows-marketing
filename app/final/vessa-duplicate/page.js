      ...
      <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8 sm:py-14">
        <header className="border-b border-[#27273A] pb-8">
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-[#B9B9CC]">
            Vessa is an execution operating system for high-stakes software and service teams. She creates tasks on her
            own, operates in two lanes (action approval and deliverable review) and keeps every move traceable.
          </p>
        ...
        <section className="border-b border-[#27273A] py-10">
          ...
          <p className="mt-4 text-[#B9B9CC]">
            Most AI tools stop at answers. Vessa creates work, executes in the right lane, and routes the checkpoint
